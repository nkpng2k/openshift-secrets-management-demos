...
configured to interact with a Private repository. If you wish to reuse
the toy deployment and service used to create this demo initially, the
yaml manifests are included in the [resources](./resources/) directory.
...
If you used the manifests from the [resources](./resources/) directory,
you can use port forwarding to test if the pod and service are running
correctly:
```
oc port-forward service/hello-openshift-ingress 8080:8080
```
