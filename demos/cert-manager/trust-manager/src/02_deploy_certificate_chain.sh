...
ROOT_CA_DURATION="${ROOT_CA_DURATION:-8760h}"
ROOT_CA_RENEW_BEFORE="${ROOT_CA_RENEW_BEFORE:-720h}"
INTERMEDIATE_CA_DURATION="${INTERMEDIATE_CA_DURATION:-2h}"
INTERMEDIATE_CA_RENEW_BEFORE="${INTERMEDIATE_CA_RENEW_BEFORE:-30m}"
LEAF_DURATION="${LEAF_DURATION:-1h}"
LEAF_RENEW_BEFORE="${LEAF_RENEW_BEFORE:-50m}"

# Substitute placeholders and apply certificate chain
sed \
  -e "s|ROOT_CA_DURATION|$ROOT_CA_DURATION|g" \
  -e "s|ROOT_CA_RENEW_BEFORE|$ROOT_CA_RENEW_BEFORE|g" \
